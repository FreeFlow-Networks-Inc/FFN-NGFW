...
class PartialCommitTests(unittest.TestCase):
    def test_named_interface_scope_preserves_other_candidate_changes(self):
        ...
        names={'commit','prepare_commit','diff','_collect_paths','_normalize_xpath','_split_xpath','_parse_step','_find_child','_find_or_create_child'}
        ...
        ns=dict(re=re,json=json,Optional=Optional,ET=ET,datetime=datetime,CANDIDATE_CONFIG='candidate',RUNNING_CONFIG='running')
        ...
        parent=manager._save.call_args.args[0].find('.//ethernet')
