...
for dir in /opt/ffn-ngfw /opt/ffn-ngfw-v2 /usr/local/lib/ffn; do
    for name in ffn_control_plane.py ffn_agent_protocol.py ffn_agent_resources.py ffn_controld_client.py ffn_planed.py ffn_policy_config.py ffn_policy_plan.py ffn_policy_profiles.py ffn_qos_config.py ffn_nat_policy.py ffn_ipv6_translation.py; do
