...
for name in ffn_controld.py ffn_controld_client.py ffn_control_plane.py ffn_agent_protocol.py ffn_agent_resources.py ffn_planed.py ffn_plane_api.py ffn_policy_config.py ffn_policy_plan.py ffn_policy_profiles.py ffn_qos_config.py ffn_nat_policy.py; do
