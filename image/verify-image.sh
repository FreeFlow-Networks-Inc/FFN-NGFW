...
# ---- 8. FFN code ---------------------------------------------------------------
sec "8. FFN software"
for p in ffn_manager.py ffn_payload.py ffn_ed25519.py ffn_config_zones.py ffn_config_subinterfaces.py ffn_policy_validation.py static/index.html static/console-shell.css; do
